...
install_jdk(){
	wget -c  -O /tmp/jdk-8u45-linux-x64.gz  http://downfiles.cimhealth.com/jdk-8u45-linux-x64.gz
	test -d /usr/java || mkdir -pv /usr/java
	tar -xf /tmp/jdk-8u45-linux-x64.gz -C /usr/java/
	mv /usr/java/jdk1.8.0_45   /usr/java/jdk
